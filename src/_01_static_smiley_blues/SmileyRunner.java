...
Smiley yay = new Smiley();
Smiley aya = new Smiley();
Smiley yaa = new Smiley();
Smiley aay = new Smiley();
Smiley yya = new Smiley();
Smiley ayy = new Smiley();
panel.add(yay);
panel.add(aya);
panel.add(yaa);
panel.add(aay);
panel.add(yya);
panel.add(ayy);
Smiley hi = new Smiley();
Smiley hih = new Smiley();
Smiley hihi = new Smiley();
panel.add(hi);
panel.add(hih);
panel.add(hihi);
		// 5. Pack your frame
